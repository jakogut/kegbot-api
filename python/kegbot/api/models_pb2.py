...
# source: kegbot/api/models.proto
...
AuthenticationToken = _reflection.GeneratedProtocolMessageType('AuthenticationToken', (_message.Message,), dict(
  DESCRIPTOR = _AUTHENTICATIONTOKEN,
  __module__ = 'kegbot.api.models_pb2'
  # @@protoc_insertion_point(class_scope:AuthenticationToken)
  ))
_sym_db.RegisterMessage(AuthenticationToken)

BeverageProducer = _reflection.GeneratedProtocolMessageType('BeverageProducer', (_message.Message,), dict(
...
Beverage = _reflection.GeneratedProtocolMessageType('Beverage', (_message.Message,), dict(
...
BeerStyle = _reflection.GeneratedProtocolMessageType('BeerStyle', (_message.Message,), dict(
...
BeerType = _reflection.GeneratedProtocolMessageType('BeerType', (_message.Message,), dict(
...
Brewer = _reflection.GeneratedProtocolMessageType('Brewer', (_message.Message,), dict(
  DESCRIPTOR = _BREWER,
  __module__ = 'kegbot.api.models_pb2'
...
Keg = _reflection.GeneratedProtocolMessageType('Keg', (_message.Message,), dict(
  DESCRIPTOR = _KEG,
  __module__ = 'kegbot.api.models_pb2'
...
KegSize = _reflection.GeneratedProtocolMessageType('KegSize', (_message.Message,), dict(
  DESCRIPTOR = _KEGSIZE,
  __module__ = 'kegbot.api.models_pb2'
...
FlowMeter = _reflection.GeneratedProtocolMessageType('FlowMeter', (_message.Message,), dict(
...
FlowToggle = _reflection.GeneratedProtocolMessageType('FlowToggle', (_message.Message,), dict(
...
KegTap = _reflection.GeneratedProtocolMessageType('KegTap', (_message.Message,), dict(
  DESCRIPTOR = _KEGTAP,
  __module__ = 'kegbot.api.models_pb2'
...
ThermoLog = _reflection.GeneratedProtocolMessageType('ThermoLog', (_message.Message,), dict(
...
ThermoSensor = _reflection.GeneratedProtocolMessageType('ThermoSensor', (_message.Message,), dict(
...
_KEG.fields_by_name['type'].has_options = True
_KEG.fields_by_name['type']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_KEG.fields_by_name['type_id'].has_options = True
_KEG.fields_by_name['type_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_KEG.fields_by_name['size_id'].has_options = True
_KEG.fields_by_name['size_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_KEG.fields_by_name['size'].has_options = True
_KEG.fields_by_name['size']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_KEG.fields_by_name['size_name'].has_options = True
_KEG.fields_by_name['size_name']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_KEG.fields_by_name['size_volume_ml'].has_options = True
_KEG.fields_by_name['size_volume_ml']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_KEG.fields_by_name['volume_ml_remain'].has_options = True
_KEG.fields_by_name['volume_ml_remain']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_KEG.fields_by_name['spilled_ml'].has_options = True
_KEG.fields_by_name['spilled_ml']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_KEGTAP.fields_by_name['meter_name'].has_options = True
_KEGTAP.fields_by_name['meter_name']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_SESSION.fields_by_name['slug'].has_options = True
_SESSION.fields_by_name['slug']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_THERMOSENSOR.fields_by_name['last_temp'].has_options = True
_THERMOSENSOR.fields_by_name['last_temp']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_THERMOSENSOR.fields_by_name['last_time'].has_options = True
_THERMOSENSOR.fields_by_name['last_time']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
