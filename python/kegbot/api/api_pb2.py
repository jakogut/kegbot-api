...
_SYNCRESPONSE.fields_by_name['controllers'].message_type = kegbot_dot_api_dot_models__pb2._CONTROLLER
_SYNCRESPONSE.fields_by_name['drinks'].message_type = kegbot_dot_api_dot_models__pb2._DRINK
_SYNCRESPONSE.fields_by_name['events'].message_type = kegbot_dot_api_dot_models__pb2._SYSTEMEVENT
_SYNCRESPONSE.fields_by_name['active_kegs'].message_type = kegbot_dot_api_dot_models__pb2._KEG
_SYNCRESPONSE.fields_by_name['meters'].message_type = kegbot_dot_api_dot_models__pb2._FLOWMETER
_SYNCRESPONSE.fields_by_name['site_info'].message_type = kegbot_dot_api_dot_models__pb2._SITEINFO
_SYNCRESPONSE.fields_by_name['sound_events'].message_type = kegbot_dot_api_dot_models__pb2._SOUNDEVENT
_SYNCRESPONSE.fields_by_name['taps'].message_type = kegbot_dot_api_dot_models__pb2._KEGTAP
_SYNCRESPONSE.fields_by_name['toggles'].message_type = kegbot_dot_api_dot_models__pb2._FLOWTOGGLE
_SYNCRESPONSE.fields_by_name['active_session'].message_type = kegbot_dot_api_dot_models__pb2._SESSION
_SYNCRESPONSE.fields_by_name['active_users'].message_type = kegbot_dot_api_dot_models__pb2._USER
...
Meta = _reflection.GeneratedProtocolMessageType('Meta', (_message.Message,), dict(
  DESCRIPTOR = _META,
  __module__ = 'kegbot.api.api_pb2'
  # @@protoc_insertion_point(class_scope:Meta)
  ))
_sym_db.RegisterMessage(Meta)

UserRegistrationRequest = _reflection.GeneratedProtocolMessageType('UserRegistrationRequest', (_message.Message,), dict(
...
RecordDrinkRequest = _reflection.GeneratedProtocolMessageType('RecordDrinkRequest', (_message.Message,), dict(
...
RecordTemperatureRequest = _reflection.GeneratedProtocolMessageType('RecordTemperatureRequest', (_message.Message,), dict(
